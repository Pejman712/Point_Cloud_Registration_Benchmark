...
from point_cloud_registration import PlaneICP


METHOD_NAME = "pcr_point_to_plane_icp"
...
def cloud_to_numpy(cloud):
    ...
    if CONFIG["max_points"] > 0 and len(points) > CONFIG["max_points"]:
        ...
        idx = rng.choice(len(points), size=CONFIG["max_points"], replace=False)
        points = points[idx]
    ...
    try:
        ...
        return {
            ...
            "debug": {
                ...
                "method": "point_cloud_registration.PlaneICP",
            },
        }

    except Exception as e:
        return identity_result(f"pcr_point_to_plane_icp failed: {e}")